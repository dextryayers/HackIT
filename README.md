...
<p align="center">
  <a href="https://github.com/dextryayers/HackIT"><img src="https://img.shields.io/badge/version-v2.1_Apex-blue.svg?style=for-the-badge" alt="Version"></a>
  <a href="https://opensource.org/licenses/MIT"><img src="https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge" alt="License: MIT"></a>
  <a href="#"><img src="https://img.shields.io/badge/status-Active_Development-success.svg?style=for-the-badge" alt="Status"></a>
  <a href="#"><img src="https://img.shields.io/badge/type-Offensive_Security_AI-8A2BE2.svg?style=for-the-badge" alt="Ethical Tool"></a>
</p>

<p align="center">
  <a href="https://www.python.org/"><img src="https://img.shields.io/badge/Python-3.10+-3776AB.svg?style=for-the-badge&logo=python&logoColor=white" alt="Python Version"></a>
  <a href="https://go.dev/"><img src="https://img.shields.io/badge/Go-1.21+-00ADD8.svg?style=for-the-badge&logo=go&logoColor=white" alt="Go Version"></a>
...
```mermaid
flowchart TD
    classDef startNode fill:#e74c3c,stroke:#c0392b,stroke-width:2px,color:#fff
    classDef decLeft fill:#1e8449,stroke:#145a32,stroke-width:2px,color:#fff
    classDef stepLeft fill:#d35400,stroke:#a04000,stroke-width:2px,color:#fff
    classDef decRight fill:#9acd32,stroke:#6b8e23,stroke-width:2px,color:#fff
    classDef stepRight fill:#8a2be2,stroke:#4b0082,stroke-width:2px,color:#fff

    Start(["HackIT CLI (main.py)"]):::startNode
    Dec1{"Go: WAF Detected?"}:::decLeft
    DecA{"Passive OSINT Scope?"}:::decRight
    
    Start-->|Active Attack|Dec1
    Start-->|Passive Only|DecA
    
    Step1["Python: Activate Proxy Jitter"]:::stepLeft
    Dec2{"Go: Web Ports Open?"}:::decLeft
    ...
    Step4["Go: Native Deep Fuzzer"]:::stepLeft
    Step3["Python: Auto SQLi XSS"]:::stepLeft
...
[![Star History Chart](https://api.star-history.com/svg?repos=dextryayers/HackIT&type=Date)](https://star-history.com/#dextryayers/HackIT&Date)
