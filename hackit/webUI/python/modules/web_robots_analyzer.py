...
async def crawl(target: str, client: httpx.AsyncClient) -> list[IntelligenceFinding]:
    ...
    for proto in ["https", "http"]:
        try:
            resp = await safe_fetch(client,f"{proto}://{domain}/robots.txt", timeout=10.0, follow_redirects=False, headers={"User-Agent": UA})
    ...
    if disallowed_paths:
        ...
        if interesting_disallowed:
            findings.append(make_finding(
                ...
                ftype="Robots: Interesting Disallowed",
                source="RobotsAnalyzer",
                confidence="Medium",
                color="red",
    ...
    if parsed["sitemaps"]:
        findings.append(make_finding(
            ...
            ftype="Robots: Sitemap References",
            source="RobotsAnalyzer",
            confidence="High",
            color="blue",
            threat_level="Informational",
