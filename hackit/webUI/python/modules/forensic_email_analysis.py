...
async def _analyze_spf_deep(domain: str, client) -> list:
    findings = []
            ...
            if ans.get("type") == 16:
                ...
                if txt.startswith("v=spf1"):
                    findings.append(make_finding(
                        ...
                        ftype="Forensic Email - SPF Record",
                        source="Google DoH",
                        ...
                        for m in matches:
                            ...
                            if mtype == "all":
                                ...
                                findings.append(make_finding(
                                    ...
                                    ftype="Forensic Email - SPF All Mechanism",
                                    source="Google DoH",
                                    confidence="High",
                                ...
                                findings.append(make_finding(
                                    ...
                                    ftype=f"Forensic Email - SPF {mtype.upper()} Mechanism",
                                    source="Google DoH",
                                    confidence="High", color="slate",
                                    raw_data=m,
                                    tags=["forensic", "email", "spf", mtype]
                            ...
                            for r_ans in redir_data.get("Answer", []):
                                if r_ans.get("type") == 16 and r_ans.get("data", "").startswith("v=spf1"):
                                    findings.append(make_finding(
                                        ...
                                        ftype="Forensic Email - SPF Redirect Target",
                                        source="Google DoH",
                                        confidence="High", color="slate",
...
async def _analyze_dkim_deep(domain: str, client) -> list:
    findings = []
                ...
                if ans.get("type") == 16:
                    ...
                    if "v=DKIM1" in dkim_txt or "v=dkim1" in dkim_txt:
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DKIM Selector Found",
                            source="Google DoH",
                        ...
                        if k_match:
                            ...
                            findings.append(make_finding(
                                ...
                                ftype="Forensic Email - DKIM Algorithm",
                                source="Google DoH",
                                confidence="High", color="slate",
                        ...
                        if p_match:
                            ...
                            if key_data == "" or len(key_data) < 10:
                                findings.append(make_finding(
                                    ...
                                    ftype="Forensic Email - DKIM Key Revoked",
                                    source="Google DoH",
                                ...
                                findings.append(make_finding(
                                    ...
                                    ftype="Forensic Email - DKIM Key Strength",
                                    source="Google DoH",
                                    confidence="Medium",
                        ...
                        if t_match:
                            ...
                            if "s" in flags:
                                findings.append(make_finding(
                                    ...
                                    ftype="Forensic Email - DKIM Flags",
                                    source="Google DoH",
                                    confidence="High", color="slate",
                        ...
                        if s_match:
                            ...
                            findings.append(make_finding(
                                ...
                                ftype="Forensic Email - DKIM Service Type",
                                source="Google DoH",
                                confidence="High", color="slate",
...
async def _analyze_dmarc_deep(domain: str, client) -> list:
    findings = []
    data = await safe_fetch_json(client,
            ...
            if ans.get("type") == 16:
                ...
                if dmarc_txt.startswith("v=DMARC1"):
                    findings.append(make_finding(
                        ...
                        ftype="Forensic Email - DMARC Record",
                        source="Google DoH",
                        confidence="High", color="slate",
                    ...
                    if p_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Policy",
                            source="Google DoH",
                            confidence="High",
                    ...
                    if sp_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Subdomain Policy",
                            source="Google DoH",
                            confidence="High", color="slate",
                    ...
                    if fo_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Forensic Options",
                            source="Google DoH",
                            confidence="High", color="slate",
                    ...
                    if rf_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Report Format",
                            source="Google DoH",
                            confidence="High", color="slate",
                    ...
                    if ri_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Report Interval",
                            source="Google DoH",
                            confidence="High", color="slate",
                    ...
                    if pct_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Sampling Rate",
                            source="Google DoH",
                            confidence="High",
                    ...
                    if rua_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Aggregate Report URI",
                            source="Google DoH",
                            confidence="High", color="orange",
                    ...
                    if ruf_match:
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - DMARC Forensic Report URI",
                            source="Google DoH",
                            confidence="High", color="orange",
...
async def _check_mta_sts_tlsrpt(domain: str, client) -> list:
    findings = []
    data = await safe_fetch_json(client,
            ...
            if ans.get("type") == 16:
                ...
                if "v=STSv1" in txt:
                    findings.append(make_finding(
                        ...
                        ftype="Forensic Email - MTA-STS Record",
                        source="Google DoH",
                        confidence="High", color="emerald",
                    ...
                    if id_match:
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - MTA-STS Policy ID",
                            source="Google DoH",
                            confidence="High", color="slate",
                            tags=["forensic", "email", "mta-sts", "id"]
                        ))
    data2 = await safe_fetch_json(client,
        f"https://dns.google/resolve?name=_smtp._tls.{domain}&type=TXT",
        headers={"Accept": "application/json"})
    if data2:
        for ans in data2.get("Answer", []):
            if ans.get("type") == 16:
                txt = ans.get("data", "")
                if "v=TLSRPTv1" in txt:
                    findings.append(make_finding(
                        entity=f"TLS-RPT: {txt[:300]}",
                        ftype="Forensic Email - TLS Reporting Record",
                        source="Google DoH",
                        confidence="High", color="emerald",
                    ...
                    if rua_tls:
                        findings.append(make_finding(
                            ...
                            ftype="Forensic Email - TLS Report URI",
                            source="Google DoH",
                            confidence="High", color="slate",
