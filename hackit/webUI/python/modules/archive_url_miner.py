        ...
        if takeover:
            for tko in takeover:
                findings.append(make_finding(
                    ...
                    ftype="Archive URL Mining: Takeover Risk",
                    source="Wayback CDX",
                    confidence="Low",
                    color="red",
...
async def classify_urls_by_pattern(urls: list) -> list:
    ...
    for group, matched_urls in sorted(pattern_matches.items(), key=lambda x: -len(x[1])):
        findings.append(make_finding(
            ...
            ftype=f"Archive URL Mining: {group}",
            source="Wayback CDX",
            confidence="Medium",
    ...
    if found_sensitive:
        for sp in found_sensitive:
            findings.append(make_finding(
                ...
                ftype="Archive URL Mining: Sensitive Parameters",
                source="Wayback CDX",
                confidence="Medium",
                color="red",
                threat_level="High Risk",
        ...
        for name, count in top_params:
            if name not in found_sensitive:
                findings.append(make_finding(
                    ...
                    ftype="Archive URL Mining: Common Parameters",
                    source="Wayback CDX",
                    confidence="Low",
                    color="slate",
                    status="Analyzed",
...
async def extract_js_css_urls(urls: list) -> list:
    ...
    if js_urls:
        findings.append(make_finding(
            ...
            ftype="Archive URL Mining: JS Files",
            source="Wayback CDX",
            confidence="Medium",
            color="slate",
    ...
    if css_urls:
        findings.append(make_finding(
            ...
            ftype="Archive URL Mining: CSS Files",
            source="Wayback CDX",
            confidence="Low",
            color="slate",
...
async def crawl(target: str, client: httpx.AsyncClient) -> List[IntelligenceFinding]:
    ...
    if cdx_results:
        ...
        findings.append(make_finding(
            ...
            ftype="Archive URL Mining: Results",
            source="Wayback CDX",
            confidence="High",
            color="slate",
        ...
        if all_params:
            for param, count in sorted(all_params.items(), key=lambda x: -x[1])[:10]:
                findings.append(make_finding(
                    ...
                    ftype="Archive URL Mining: Parameter Discovery",
                    source="Wayback CDX",
                    confidence="Medium",
                    color="slate",
                    status="Discovered",
        ...
        if file_extensions:
            for ext, count in sorted(file_extensions.items(), key=lambda x: -x[1])[:10]:
                findings.append(make_finding(
                    ...
                    ftype="Archive URL Mining: Extension Analysis",
                    source="Wayback CDX",
                    confidence="Medium",
                    color="slate",
                    status="Analyzed",
    ...
    if not findings:
        findings.append(make_finding(
            ...
            ftype="Archive URL Mining: Complete",
            source="Wayback CDX",
            confidence="Low",
            color="emerald",
            threat_level="Informational",
