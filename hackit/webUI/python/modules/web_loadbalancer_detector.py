        ...
        try:
            ...
            for hdr, lb_type in LB_HEADER_PATTERNS.items():
                if hdr in headers:
                    ...
                    findings.append(make_finding(
                        ...
                        ftype="LB: Load Balancer Header",
                        source="LoadBalancerDetector",
                        confidence="High",
                        color="blue",
                        threat_level="Informational",
                        raw_data=f"header={hdr}, value={headers[hdr][:200]}, ftype={lb_type}",
                ...
                for pattern, lb_type in LB_COOKIE_PATTERNS.items():
                    if re.search(pattern, cookie_name, re.I):
                        ...
                        findings.append(make_finding(
                            ...
                            ftype="LB: Load Balancer Cookie",
                            source="LoadBalancerDetector",
                            confidence="High",
                            color="purple",
                            threat_level="Informational",
                            raw_data=f"cookie={cookie_name}, value={cookie_val[:50]}, ftype={lb_type}",
            ...
            if unique_headers or unique_cookies:
                ...
                findings.append(make_finding(
                    ...
                    ftype="LB: Load Balancer Detection",
                    source="LoadBalancerDetector",
                    confidence="High",
                    color="purple",
                    threat_level="Informational",
            ...
            for i in range(3):
                try:
                    r = await safe_fetch(client,f"{proto}://{domain}", timeout=10.0, follow_redirects=False, headers={"User-Agent": UA, "X-Forwarded-For": f"10.0.0.{random.randint(1, 255)}"})
            ...
            if len(response_times) >= 2:
                ...
                if variance > RESPONSE_TIME_VARIANCE_THRESHOLD:
                    findings.append(make_finding(
                        ...
                        ftype="LB: Response Time Variance",
                        source="LoadBalancerDetector",
                        confidence="Medium",
                        color="yellow",
                        threat_level="Informational",
                    ...
                    findings.append(make_finding(
                        ...
                        ftype="LB: Consistent Response Times",
                        source="LoadBalancerDetector",
                        confidence="Medium",
                        color="emerald",
                        threat_level="Informational",
