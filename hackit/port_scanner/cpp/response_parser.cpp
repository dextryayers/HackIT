...
// ---------- HTTP Parser ----------
static ParsedResponse parse_http(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "HTTP";
    pr.raw = raw;
    ...
    std::string header_section = std::string(raw);
    if (header_end != std::string::npos) {
...
// ---------- SMTP Parser ----------
static ParsedResponse parse_smtp(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "SMTP";
    pr.raw = raw;
...
// ---------- POP3 Parser ----------
static ParsedResponse parse_pop3(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "POP3";
    pr.raw = raw;
...
// ---------- IMAP Parser ----------
static ParsedResponse parse_imap(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "IMAP";
    pr.raw = raw;
...
// ---------- FTP Parser ----------
static ParsedResponse parse_ftp(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "FTP";
    pr.raw = raw;
...
// ---------- SSH Parser ----------
static ParsedResponse parse_ssh(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "SSH";
    pr.raw = raw;
...
// ---------- MySQL Parser ----------
static ParsedResponse parse_mysql(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
    pr.protocol = "MySQL";
    pr.raw = raw;
...
// ---------- PostgreSQL Parser ----------
static ParsedResponse parse_postgresql(std::string_view raw, int port) {
    ParsedResponse pr;
    pr.port = port;
...
static ParsedResponse parse_response(std::string_view raw, int port, std::string_view hint_protocol) {
    std::string upper = std::string(raw);
