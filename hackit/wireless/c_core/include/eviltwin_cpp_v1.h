#ifndef EVILTWIN_CPP_V1_H
#define EVILTWIN_CPP_V1_H
...
class EviltwinBeaconV1 {
public:
    EviltwinBeaconV1(const std::string& iface, const std::string& ssid,
...
private:
    ...
    uint8_t deauth_client_frame_[64];
    int deauth_client_frame_len_ = 0;
